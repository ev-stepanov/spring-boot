-- Справочник №1
INSERT INTO Doc_type (orgId, version, doc_code, doc_name) VALUES (1, 0, 433, 'Passport');
INSERT INTO Doc_type (orgId, version, doc_code, doc_name) VALUES (2, 0, 24, 'Military ID');

-- Справочник №2
INSERT INTO Country (orgId, version, citizenship_code, citizenship_name) VALUES (1, 0, 64, 'USA');
INSERT INTO Country (orgId, version, citizenship_code, citizenship_name) VALUES (2, 0, 77, 'Japan');

-- Организация №1
INSERT INTO Organization (orgId, version, name,  full_name, inn, kpp, address, phone)
VALUES (1, 0, 'Microsoft', 'Microsoft Corporation', '6449013711', '644901001', 'USA', '12121234567');

-- Офис №1
INSERT INTO Office (orgId, version, org_id,  name, address, phone)
VALUES (1, 0, 1, 'Microsoft Washington', 'Washington 12', '12126458365');

--Документ работника №1
INSERT INTO Doc_user(orgId, version, doc_id, doc_date, doc_number)
VALUES (1, 0, 1, '2015-09-28', '404426');

-- Работник №1
INSERT INTO User (orgId, version, office_id, first_name, second_name, middle_name, doc_user_id,
...
-- Работник №4
INSERT INTO User (orgId, version, office_id, first_name, second_name, doc_user_id,
                  citizenship_id, position, phone)
